...
if __name__ == "__main__":
    load_from_pretrained = "/dockerdata/wufan/DanceGRPO/videoalign_ckpt"
    device = "cuda:0"
    ...
    video_paths = [
        "/mnt/kaiwu-group-y1-sh-hdd/wufan/codes/DanceGRPO/debug/output.mp4",
        "/mnt/kaiwu-group-y1-sh-hdd/wufan/codes/DanceGRPO/debug/output_origin.mp4",
        "/mnt/kaiwu-group-y1-sh-hdd/wufan/codes/DanceGRPO/debug/output_del.mp4",
    ]
