...
def load_model_from_checkpoint(
    ...
    if os.path.exists(full_ckpt):
        ...
        for k, v in model_state_dict.items():
            # add `.model.` after "base_model.model"
            if k.startswith("base_model.model.visual."):
                new_k = k.replace("base_model.model.visual.", "base_model.model.model.visual.")
            elif "visual" not in k:
                new_k = k.replace("base_model.model.model.", "base_model.model.model.language_model.")
                # new_k = k
            new_ckpt[new_k] = v
